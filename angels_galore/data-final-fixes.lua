...
if settings.startup["vgal-override-vanilla-crafting-speeds"].value then
...
--- tocomebackat, use setting
for _, recipe in pairs(data.raw["recipe"]) do
    if vgal.recipe.has_category(recipe, "angels-barreling-pump") then
