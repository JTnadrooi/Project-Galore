vgal.icon.create_handlers["arrow"] = function(blueprint)
    ...
    table.insert(composites, vgal.icon.shift(vgal.icon.get(blueprint.inputs[1]), 0.76, { -6.5, -6.5 }))
    table.insert(composites, vgal.icon.shift(vgal.icon.get(blueprint.outputs[1]), 0.7, { 5.5, 6.5 }))
