vgal.data.extend({
    ...
    },
    {
        ...
        results = {
            ...
            { "biter-egg",             1, { independent_probability = 0.80 } },
            { "pentapod-egg",          1, { independent_probability = 0.20 } },
            { "barrel",                1, { independent_probability = 0.85 } },
        },
        category = "captive-spawner-process",
    ...
    },
    {
        ...
        results = {
            ...
            { "biter-egg",             1, { independent_probability = 0.20 } },
            { "pentapod-egg",          1, { independent_probability = 0.80 } },
            { "barrel",                1, { independent_probability = 0.85 } },
        },
        category = "captive-spawner-process",
        allow_productivity = false,
