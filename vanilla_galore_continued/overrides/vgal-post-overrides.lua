...
if mods["quality"] then
    ...
    if q_upgrades_mode ~= "disabled" then
        ...
        local upgrade_recipes = {
            ...
            ["vgal-electric-engine-unit-assembling-machine-1"] = true,
            ["vgal-electric-engine-unit-assembling-machine-2"] = true,
        ...
        if vgal.defines.flags["sagal"] then
            ...
            upgrade_recipes["vgal-holmium-plate-electronic-circuit"] = true
        end
